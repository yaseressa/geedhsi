function Header({ type }) {
  return (
    <>
      {type == "h" && (
        <div className="flex justify-between  items-center w-[100%] relative top-14 ">
          <div className="w-[50%]">
            <div className="bg-primary p-3 pl-20 pr-5 rounded-tr-full rounded-br-full w-[60%]">
              <span className="font-rockwell text-4xl text-white tracking-widest font-bold">
                GEEDHSI
              </span>
            </div>
          </div>
          ...
          <div className="w-[50%] overflow-x-hidden">
            <ul className="translate-x-16 flex justify-evenly items-center text-lg font-nunito overflow-x-hidden">
              <li className=" text-primary font-nunito">
                <a href="#about">About</a>
              </li>
              <li className=" text-primary font-nunito">
                <a href="#service">Service</a>
              </li>
              <li className="text-white bg-primary rounded-full px-6 py-2">
      ...
      {type == "d" && (
        <div className="flex justify-between  items-center w-[100%] relative top-2 ">
          <div className=" flex justify-start items-center w-[30%]">
            ...
            <h2 className="font-rockwell text-white tracking-wider text-md">
              admin
            </h2>
          </div>
          <div className="w-[40%] flex justify-center items-center">
            <div className="p-1 rounded-tr-full rounded-br-full ">
              <span className="font-rockwell text-5xl text-white tracking-widest font-bold">
                GEEDHSI
              </span>
            </div>
          </div>

          <div className="w-[30%] overflow-x-hidden flex justify-end pr-10">
            <a
              href=""
              className="text-primary font-rockwell  tracking-widest text-xl"
            >
              logout
            </a>
          </div>
